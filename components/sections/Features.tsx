...
export default function Features() {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[600px] md:min-h-[800px] bg-white dark:bg-gray-950 overflow-x-clip py-20 px-4 md:px-20 flex flex-col md:flex-row items-center justify-center transition-colors">
