...
const Navbar = () => {
  ...
  return (
    <nav
      className="w-full py-6 px-4 sm:px-8 max-w-7xl mx-auto flex items-center justify-between bg-white dark:bg-gray-900 relative transition-colors"
      role="navigation"
    ...
    >
      ...
      {isMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white dark:bg-gray-900 shadow-lg md:hidden z-40 border-t border-gray-200 dark:border-gray-700 transition-colors">
