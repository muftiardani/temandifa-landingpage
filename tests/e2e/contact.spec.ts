...
test.describe('Contact Form E2E', () => {
  ...
  test('should display contact page with form', async ({ page }) => {
    ...
    await expect(page.locator('h1')).toContainText(/hubungi|contact/i, { timeout: 10000 });
  ...
  test('should have clickable social media links', async ({ page }) => {
    ...
    await expect(instagramLink).toHaveAttribute('target', '_blank', { timeout: 10000 });
    ...
    const linkedinLink = page.locator('a[href*="linkedin.com/company/temandifa"]');
  ...
  test('should validate message length', async ({ page }) => {
    ...
    const lengthError = page.locator('text=/pesan minimal|message must be at least/i');
